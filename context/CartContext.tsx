...
interface CartContextType {
  ...
  clearCart: () => void;
  checkout: (email: string, name: string, phone: string | undefined, branchName: string, pickupTime: string, paymentMethod: string, momoDeposit?: number, fulfillmentMode?: FulfillmentMode, deliveryAddress?: string, deliveryLocation?: string, deliveryTime?: string) => void;
...
export const CartProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const checkout = (email: string, name: string, phone: string | undefined, branchName: string, pickupTime: string, paymentMethod: string, momoDeposit?: number, fulfillmentMode: FulfillmentMode = 'delivery', deliveryAddress?: string, deliveryLocation?: string, deliveryTime?: string) => {
